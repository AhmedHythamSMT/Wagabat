...
class MexicanActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerOne.apply {
            layoutManager = LinearLayoutManager(this@MexicanActivity, LinearLayoutManager.VERTICAL, false)
            adapter = typAdapter
        }
    }
